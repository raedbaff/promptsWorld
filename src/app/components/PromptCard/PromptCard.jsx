...
const PromptCard = ({ prompt, handleDelete }) => {
  ...
  return (
    <div className="prompt-card">
      <div className="creator-info">
        ...
        <span className="creator-email">{prompt.creator.email}</span>
        <Image
          className="cursor-pointer ml-1"
          src={copied ? "/images/tick.svg" : "/images/copy.svg"}
          alt="copy"
          width={30}
          height={30}
          onClick={handleCopy}
        ...
        <div className="footer">
          ...
          <div className="CardButtons">
            <button
              ...
              onClick={() => {
                router.push(`/${prompt._id}`);
              }}
            >
              Edit
            </button>
            <button className="CardDeleteButton" onClick={handleDelete}>
              Delete
            </button>
          </div>
        </div>
